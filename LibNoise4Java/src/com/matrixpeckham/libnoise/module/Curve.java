 ...
 *
 * <img src="modulecurve.png" alt="MODULE_CURVE_IMAGE" />
 *
 ...
 *
 * <img src="curve.png" alt="CURVE_IMAGE" />
 *
...
public class Curve extends Module {
     ...
     * array.
     */
    protected ArrayList<ControlPoint> controlPoints;
     ...
     */
    public ArrayList<ControlPoint> getControlPointArray() {
    ...
    public double getValue(double x, double y, double z) {
        ...
        int index0 = Globals.clampValue(indexPos - 2, 0, controlPoints.size()
                - 1);
        int index1 = Globals.clampValue(indexPos - 1, 0, controlPoints.size()
                - 1);
        int index2 = Globals.clampValue(indexPos, 0, controlPoints.size() - 1);
        int index3 = Globals.clampValue(indexPos + 1, 0, controlPoints.size()
                - 1);
        ...
        return Globals.cubicInterp(controlPoints.get(index0).outputValue,
    ...
    protected void insertAtPos(int insertionPos, double inputValue,
            double outputValue) {
        //because we swithced to ArrayList, we don't have to do the bookkeeping
