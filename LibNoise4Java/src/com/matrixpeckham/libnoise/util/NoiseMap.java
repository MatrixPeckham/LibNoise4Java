...
/**
 * Implements a noise map, a 2-dimensional array of doubleing-point values.
 *
 ...
 * double values between these two starting points, not by the number of bytes.
...
public class NoiseMap {
    ...
    public void reclaimMem() {
        ...
        if (memUsed > newMemUsage) {
            ...
            for (int y = 0; y < height; y++) {
                System.arraycopy(noiseMap[y], 0, newNoiseMap[0], 0, width);
            }
